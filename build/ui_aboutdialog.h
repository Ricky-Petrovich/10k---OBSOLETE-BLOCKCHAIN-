...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_10k_copyright = new QLabel(AboutDialog);
        label_10k_copyright->setObjectName(QString::fromUtf8("label_10k_copyright"));
        label_10k_copyright->setWordWrap(true);
        label_10k_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_10k_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About 10k", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<b>10k</b> version", 0, QApplication::UnicodeUTF8));
        label_10k_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 10k Developers", 0, QApplication::UnicodeUTF8));

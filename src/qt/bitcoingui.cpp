...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a 10k address"));
    ...
    aboutAction->setToolTip(tr("Show information about 10k"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for 10k"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &10k"), this);
    toggleHideAction->setToolTip(tr("Show or hide the 10k window"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/10k_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/10k_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("10k client"));
    ...
    notificator = new Notificator(tr("10k-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 10k network", "", count));
}

...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("10k");
    case mBTC: return QString("m10k");
    case uBTC: return QString::fromUtf8("μ10k");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("10k");
    case mBTC: return QString("Milli-10k (1 / 1,000)");
    case uBTC: return QString("Micro-10k (1 / 1,000,000)");
    default: return QString("???");
    }
}
